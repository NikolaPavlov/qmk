...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | _FN  | Ctrl | Alt  | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Ctrl  |
     * `-----------------------------------------------------------------------------------'
     */
    [_DEFLT] = LAYOUT( \
        ...
        KC_LCTL, MO(_FN), KC_LALT, KC_LGUI, MO(_LOWER),LALT_T(KC_SPC),LALT_T(KC_SPC),MO(_RAISE),KC_LEFT, KC_DOWN, KC_UP,   KC_RCTL       \
    ),
